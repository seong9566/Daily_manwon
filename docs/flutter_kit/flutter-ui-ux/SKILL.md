...
```dart
static const primary = Color(0xFF1A3A5C);        // 진한 파란색
static const primaryLight = Color(0xFF2C5F8A);   // 밝은 파란색
static const secondary = Color(0xFF2EC4B6);      // 민트
static const accent = Color(0xFF3B82F6);         // 액센트 파란색
static const error = Color(0xFFE53E3E);          // 에러 빨강
static const surface = Color(0xFFF7F8FA);        // 배경색
static const cardBackground = Colors.white;      // 카드 배경
static const disabled = Color(0xFFBDBDBD);       // 비활성 회색
static const textPrimary = Color(0xFF1A1A1A);    // 주 텍스트
static const textSecondary = Color(0xFF6B7280);  // 보조 텍스트
static const divider = Color(0xFFE5E7EB);        // 구분선
static const bleOn = Color(0xFF3B82F6);          // BLE 활성
static const nfcOn = Color(0xFF2EC4B6);          // NFC 활성
static const statusOff = Color(0xFF9CA3AF);      // 상태 비활성
```
