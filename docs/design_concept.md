...
| 남은 금액 (주의) | 60sp | ExtraBold (800) | `hero_budget_number.dart` |
...
| 상태 | 조건 | 크기 | 색상 | 모션 |
|------|------|------|------|------|
| 여유 | ≥ 5,000원 | 72sp, w900 | #2DBD8E | 바운스 scale (elasticOut, 300ms) |
| 주의 | 1,000~4,999원 | 60sp, w800 | #F5A623 | 바운스 + shakeX (2px, 1회) |
| 위험 | 0~999원 | 52sp, w700 | #E85D5D | 바운스 + shakeX (2px, 1회) |
| 초과 | < 0원 | 48sp, w700 | #C0392B | 바운스 + shakeX (4px, hz:4, 1회) |
